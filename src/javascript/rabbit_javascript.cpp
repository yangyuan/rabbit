...
void _javascript_log(const FunctionCallbackInfo<Value>& args) {
    ...
    const char * arg_0 = _javascript_to_string(args, 0);
    rabbit_log(arg_0);
}

void _javascript_sleep(const FunctionCallbackInfo<Value>& args) {
    Isolate* isolate = args.GetIsolate();
    unsigned int arg_0 = _javascript_to_uint32(args, 0);
    rabbit_sleep(arg_0);
}
...
void _javascript_moveto(const FunctionCallbackInfo<Value>& args) {
    Isolate* isolate = args.GetIsolate();
    unsigned int arg_0 = _javascript_to_uint32(args, 0);
    unsigned int arg_1 = _javascript_to_uint32(args, 1);
...
void _javascript_findcolor(const FunctionCallbackInfo<Value>& args) {
    ...
    unsigned int arg_0 = _javascript_to_uint32(args, 0);
    unsigned int arg_1 = _javascript_to_uint32(args, 1);
    unsigned int arg_2 = _javascript_to_uint32(args, 2);
    unsigned int arg_3 = _javascript_to_uint32(args, 3);
    unsigned int arg_4 = _javascript_to_uint32(args, 4);
    double arg_5 = _javascript_to_double(args, 5);
...
void _javascript_find_window(const FunctionCallbackInfo<Value>& args) {
    ...
    unsigned int ret_0;
    const char * arg_0 = _javascript_to_string(args, 0);
    const char * arg_1 = _javascript_to_string(args, 1);
