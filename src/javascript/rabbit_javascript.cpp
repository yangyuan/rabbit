...
void _javascript_mouse_get_cursor_id(const FunctionCallbackInfo<Value>& args) {
    Rabbit * rabbit = new Rabbit();
    Isolate* isolate = args.GetIsolate();
    unsigned int ret_0;
...
void _javascript_mouse_get_cursor_hash(const FunctionCallbackInfo<Value>& args) {
    Rabbit * rabbit = new Rabbit();
    Isolate* isolate = args.GetIsolate();
    unsigned int ret_0;
...
void _javascript_keyboard_press_vkey(const FunctionCallbackInfo<Value>& args) {
    Rabbit * rabbit = new Rabbit();
    Isolate* isolate = args.GetIsolate();
    unsigned int arg_0 = _javascript_to_uint32(rabbit, args, 0);
...
void _javascript_window_find_focus(const FunctionCallbackInfo<Value>& args) {
    Rabbit * rabbit = new Rabbit();
    Isolate* isolate = args.GetIsolate();
    long long ret_0;
...
void _rabbit_javascript_init(Local<Object> exports) {
    ...
    NODE_SET_METHOD(exports, "mouse_get_cursor_id", _javascript_mouse_get_cursor_id);
    NODE_SET_METHOD(exports, "mouse_get_cursor_hash", _javascript_mouse_get_cursor_hash);
...
Local<Data> rabbit_javascript(Isolate* isolate) {
    ...
    rabbit->Set(String::NewFromUtf8(isolate, "mouse_get_cursor_id"), FunctionTemplate::New(isolate, _javascript_mouse_get_cursor_id));
    rabbit->Set(String::NewFromUtf8(isolate, "mouse_get_cursor_hash"), FunctionTemplate::New(isolate, _javascript_mouse_get_cursor_hash));
